...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A tour name maximum length is 40 characters'],
      minlength: [10, 'A tour name minimum length is 10 characters'],
      validate: {
        validator: function (value) {
          return validator.isAlpha(value, 'en-US', { ignore: ' ' });
        },
        message: 'A tour name should only contain alphabets',
      },
    },
    slug: {
      type: String,
